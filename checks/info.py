...
def info(self):
    ...
    self.iframe_num     = len(self.f_tags("iframe")) - len(self.f_xps("//iframe[contains(@name, '_ym_native')]"))
    self.wf_frame_num   = len(self.f_xps("//iframe[contains(@src, 'offerteonline2017.com')]")) + len(self.f_xps("//iframe[contains(@src, 'newinventory.worldfilia.net')]"))
